      ...
      <a-form-model ref="newlyForm" :model="newlyForm" :rules="newlyRules" :colon="false">
        <a-row class="m-t-20">
          <a-col :span="12">
            ...
            <a-form-model-item class="flex" label="保管部门" prop="saveDept" :label-col="labelCol" :wrapper-col="wrapperCol">
            ...
            <a-form-model-item label="起升高度" prop="specialEquipmentDetail.equipmentHeight" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input-number :disabled="disabled" v-model.trim="newlyForm.specialEquipmentDetail.equipmentHeight" placeholder="运行速度" allowClear :maxLength="50"/> m
            </a-form-model-item>
            <a-form-model-item label="额定起重量" prop="specialEquipmentDetail.crownblockLimitWeight" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input-number :disabled="disabled" v-model.trim="newlyForm.specialEquipmentDetail.crownblockLimitWeight" :min="0" placeholder="额定起重量" allowClear :maxLength="50"/> t
            </a-form-model-item>
            <a-form-model-item label="跨度" prop="specialEquipmentDetail.crownblockSpan" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input-number :disabled="disabled" v-model.trim="newlyForm.specialEquipmentDetail.crownblockSpan" :min="0" placeholder="跨度" allowClear :maxLength="50"/> m
            </a-form-model-item>
            <a-form-model-item label="起升速度" prop="specialEquipmentDetail.crownblockUpSpeed" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input-number :disabled="disabled" v-model.trim="newlyForm.specialEquipmentDetail.crownblockUpSpeed" :min="0" placeholder="起升速度" allowClear :maxLength="50"/> m/s
            </a-form-model-item>
            <a-form-model-item label="制造单位" prop="specialEquipmentDetail.equipmentBuildDept" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input :disabled="disabled" v-model.trim="newlyForm.specialEquipmentDetail.equipmentBuildDept" placeholder="请输入制造单位" allowClear :maxLength="50"/>
            </a-form-model-item>
            <a-form-model-item label="安装单位" prop="specialEquipmentDetail.equipmentInstallDept" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input :disabled="disabled" v-model.trim="newlyForm.specialEquipmentDetail.equipmentInstallDept" placeholder="请输入安装单位" allowClear :maxLength="50"/>
            </a-form-model-item>
            ...
            <a-form-model-item label="检验日期" prop="checkDate" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-date-picker :disabled="disabled" format="YYYY-MM-DD" v-model="newlyForm.checkDate" placeholder="请选择检验日期" allowClear />
            </a-form-model-item>
            <a-form-model-item label="下次检验日期" prop="nextCheckDate" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-date-picker :disabled="disabled" format="YYYY-MM-DD" v-model="newlyForm.nextCheckDate" placeholder="请选择下次检验日期" allowClear/>
            </a-form-model-item>
  ...
  data() {
    return {
      ...
      newlyRules: {
        ...
        'specialEquipmentDetail.equipmentHeight': [
          { required: true, message: '请输入起升高度', trigger: ['blur', 'change'] },
        ],
        'specialEquipmentDetail.crownblockLimitWeight': [
          { required: true, message: '请输入额定起重量', trigger: ['blur', 'change'] },
        ],
        'specialEquipmentDetail.crownblockSpan': [
          { required: true, message: '请输入跨度', trigger: ['blur', 'change'] },
        ],
