  ...
  data() {
    return {
      ...
      tableData: [
        ...
        {code:'practicabilityScore',aa:"实用性",b1:'0-10分',c1:"可解决一般性的安全管理问题",b2:'11-30分',c2:"可解决安全管理过程中的实际困难，有效提升整体安全管理绩效",b3:'31-40分',c3:'可解决重点安全问题或有效管控重要危险源，有效降低公司运行安全风险',score:''},
        {code:"generalizationScore",aa:"可推广性",b1:'0-10分',c1:"仅可对单一区域或特定因素有效",b2:'11-20分',c2:"经过细化可在本公司内推广",b3:'21-30分',c3:'安全管理方法或技术解决方案可在DBG内各工厂进行推广实施，可全面提升DBG整体安全管控水平',score:''},
      ],
      approveRules: {
        reviewComments: [
