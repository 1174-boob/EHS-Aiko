  ...
  <div class="clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    ...
    <div class="pe-data-container">
      ...
      <div>
        ...
        <div @click="changeTab(1)" class="pe-data-item passed-pe-num" :class="[curIndex === 1 ? 'active' : '']">
          <span class="pe-data-body">体检合格 {{countInfo.checkQualifiedNum}} 人</span>
          <p class="en-illus">Physical fitness</p>
          <i></i>
        </div>
