...
import childComp from "@/pages/occupationHealth/dataStatsAnalyse/childComponents/index.vue";
import childComB from "@/pages/occupationHealth/dataStatsAnalyse/childComponents/indexBotton.vue";
export default {
      data() {
            return {
                  searchFormTop: {},
      ...
      computed: {},
      created() {
            this.setRouterCode("dataStatsAnalyse");
      },
      methods: {
            // 重置
            iRest: debounce(
