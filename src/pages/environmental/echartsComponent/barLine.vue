    ...
    return {
      option: {
        tooltip: {
          ...
          //     relVal += '<br/>' + params[i].marker + params[i].seriesName + ' : ' + params[i].value + ' mg/m3';
          //     }
          //   return relVal;
          // },
        },
  ...
  methods: {
    barInit() {
      if (this.myEcharts == null) {
        this.myEcharts = echarts.init(document.getElementById("bar-line"))
      }
      this.myEcharts.setOption(this.option);
    },
    resetClick(value) {
