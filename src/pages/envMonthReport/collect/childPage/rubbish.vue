...
import { tableConversion, findCorporationId, lastMonth, findData } from "./methods.js";
            ...
            boeColumns: [
                {
                    ...
                    align: "center",
                    customRender: (text) => {
                        return findData(text).rubbishName ? findData(text).rubbishName : '--'
                    },
                    width: 200,
    ...
    methods: {
        ...
        initData () {
            wasteBOE({}).then((res) => {
                ...
                this.boeTableDataList = [res.data[3], res.data[1], res.data[0], res.data[2]]
                if (res.data.length) {
                        ...
                        for (let j in res.data[i]) {
                            ...
                            if (monthText.indexOf(j) > -1) {
                                if (res.data[i].nicheItemsCode == 1113) {
                                    v1113[monthText.indexOf(j)] = res.data[i][j] == null ? 0 : res.data[i][j]
                                }
                                if (res.data[i].nicheItemsCode == 1043) {
                                    v1043[monthText.indexOf(j)] = res.data[i][j] == null ? 0 : res.data[i][j]
                                }
                                if (res.data[i].nicheItemsCode == 1092) {
                                    v1092[monthText.indexOf(j)] = res.data[i][j] == null ? 0 : res.data[i][j]
                                }
                            }
                        }
