<template>
      ...
      <div class="searchtable-wrapper clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
          ...
          <!-- 列表 -->
          <CommonTable>
              <a-table :columns="boeColumns" :scroll="{ x: 800 }" :data-source="boeTableDataList" :pagination="false" bordered :rowKey="(record, index)=>{return index}">
              </a-table>
          </CommonTable>
  ...
  import { listEnvironmentMonthlyPowerSubmodule,environmentMonthPower } from "@/services/envMonth.js";
              ...
              boeColumns: [
                  {
                    ...
                    //   title: " ",
                      ...
                      // key: "nicheItemsCode",
                      customRender: (text) => {
                          return findData(text).elecName ? findData(text).elecName : '--'
                      },
                      align: "center",
                      fixed: 'left',
                      width: 250,
