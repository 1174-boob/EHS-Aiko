  ...
  <div class="clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    ...
    <CommonTable :page="page" :pageNoChange="pageNoChange" :showSizeChange="onShowSizeChange">
      <a-table
        ...
        :pagination="false"
      >
        <div slot="status" slot-scope="record">{{dictionary('faultStatus',record.status) || '--'}}</div>
...
import { fireEquipPageList } from "@/services/api.js";
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      return fireEquipPageList(params).then((res) => {
