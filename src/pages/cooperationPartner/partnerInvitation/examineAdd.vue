          ...
          <a-row>
            <a-col :span="12">
              ...
              <a-form-model-item ref="companyName" label="企业全称" prop="companyName">
                <a-input v-model.trim="iFrom.companyName" :maxLength="50" placeholder="请输入企业全称"></a-input>
              </a-form-model-item>
              <a-form-model-item ref="companyCode" label="统一社会信用代码" prop="companyCode">
                <a-input v-model.trim="iFrom.companyCode" :maxLength="50" placeholder="请输入统一社会信用代码"></a-input>
              </a-form-model-item>

              <a-form-model-item ref="contractNo" label="安全协议合同号" prop="contractNo">
                <a-input v-model.trim="iFrom.contractNo" :maxLength="50" placeholder="请输入安全协议合同号"></a-input>
              </a-form-model-item>
              <a-form-model-item ref="supplierDirector" label="企业负责人" prop="supplierDirector">
                <a-input v-model.trim="iFrom.supplierDirector" :maxLength="50" placeholder="请输入企业负责人"></a-input>
              </a-form-model-item>
              <a-form-model-item ref="supplierSafeDirector" label="企业安全负责人" prop="supplierSafeDirector">
                <a-input v-model.trim="iFrom.supplierSafeDirector" :maxLength="50" placeholder="请输入企业安全负责人"></a-input>
              </a-form-model-item>
            </a-col>

            <a-col :span="12">
              <a-form-model-item ref="createTime" label="创建日期"  prop="createTime">
                <a-input disabled v-model.trim="iFrom.createTime" placeholder="请输入创建日期"></a-input>
              </a-form-model-item>
              ...
              <a-form-model-item ref="companyAbbreviation" label="企业简称" prop="companyAbbreviation">
                <a-input v-model.trim="iFrom.companyAbbreviation" :maxLength="50" placeholder="请输入企业简称"></a-input>
              </a-form-model-item>

              <a-form-model-item ref="mainBusiness" label="主营业务" prop="mainBusiness">
                <a-input v-model.trim="iFrom.mainBusiness" :maxLength="50" placeholder="请输入主营业务"></a-input>
              </a-form-model-item>

              <a-form-model-item ref="contractExpirationDate" label="安全协议到期日" prop="contractExpirationDate">
                <a-date-picker style="width: 100%;" v-model="iFrom.contractExpirationDate" valueFormat="YYYY-MM-DD" format="YYYY-MM-DD" placeholder="请选择安全协议到期日" />
              </a-form-model-item>
              
              <a-form-model-item ref="supplierDirectorPhone" label="负责人联系方式" prop="supplierDirectorPhone">
                <a-input v-model.trim="iFrom.supplierDirectorPhone" :maxLength="50" placeholder="请输入负责人联系方式"></a-input>
              </a-form-model-item>

              <a-form-model-item ref="supplierSafeDirectorPhone" label="安全负责人联系方式" prop="supplierSafeDirectorPhone">
                <a-input v-model.trim="iFrom.supplierSafeDirectorPhone" :maxLength="50" placeholder="请输入安全负责人联系方式"></a-input>
              </a-form-model-item>
            </a-col>
          </a-row>
        </template>
...
export default {
  components: { FixedBottom, UploadBtnStyle, SelNodeUser, StaffOrDept },//, AddCasNoModel
  ...
  mounted() {
    ...
    this.initPage()
    // 获取当前创建日期
    if (this.$route.query.invitationId === undefined){
      this.getDate()
    }
  },
  methods: {
