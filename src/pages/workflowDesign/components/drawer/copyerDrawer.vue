<template>
    <el-drawer :append-to-body="true" title="审批节点设置" :visible.sync="$store.state.copyerDrawer" direction="rtl" class="set_copyer" size="550px" :before-close="saveCopyer">
        <div class="demo-drawer__content">
            <div class="copyer_content drawer_content">
                ...
                <el-checkbox-group v-model="ccSelfSelectFlag" class="clear">
                    <el-checkbox :label="1">允许申请人自选审批节点</el-checkbox>
                </el-checkbox-group>
            </div>
...
export default {
    ...
    computed:{
        copyerConfig1(){
            return this.$store.state.setting.copyerConfig.value
        }
    },
    watch:{
        copyerConfig1(val){
