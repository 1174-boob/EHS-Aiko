        ...
        if (this.routerObj.hideDangerId) {
          ...
          if (this.hideDangerForm) {
            ...
            if (
              ...
              this.urlObj = {
                url: "/safeManage/workManage/dangerWorkStatic/dealHiddenPageAssociation",
                hideDangerId: this.routerObj.hideDangerId,
              };
            } else {
              if (this.hideDangerForm.fourPass) {
                this.urlObj = {
                  url: "/safeManage/workManage/dangerWorkStatic/dealIsFourAssociation",
                  hideDangerId: this.routerObj.hideDangerId,
                };
              } else {
                this.urlObj = {
                  url: "/safeManage/workManage/dangerWorkStatic/dealNoFourAssociation",
                  hideDangerId: this.routerObj.hideDangerId,
                };
              }
            }
