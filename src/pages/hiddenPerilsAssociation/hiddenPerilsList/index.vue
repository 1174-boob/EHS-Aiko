...
export default {
  ...
  methods: {
    ...
    // 分类配置
    earlyWarningTest() {
      this.$router.push({ path: "/safeManage/workManage/dangerWorkStatic/addHiddenPerilsAssociation" });
    },
    //获取name
    getName(list) {
      let listName = [];
    ...
    actionEdit(record, type) {
      ...
      if (
        ...
        this.$router.push({
          path: "/safeManage/workManage/dangerWorkStatic/dealHiddenPageAssociation",
          query: {
