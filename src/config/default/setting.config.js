...
module.exports = {
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    { link: 'https://beian.miit.gov.cn/#/Integrated/index', name: '京ICP备20001354号-9' },
    // {link: 'https://code.boeplat.com/boeplat/boeplat-ziid-web', icon: '二级节点'},
    { link: 'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11011502004299', name: '京公网安备 11011502004654号' }
  ],
}
