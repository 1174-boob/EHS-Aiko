<template>
  ...
  <div class="searchtable-wrapper clx-show-scroll clx-flex-1 beauty-scroll">  
    <div v-show="true" class="searchtable-box">
      ...
      <!-- 虚线按钮 -->
      <div class="dashed-btn clx-btn-dashed-box m-b-15">
...
// import InvitationCooperationBtn from "../invitationCompanyBtn/invitationCompanyBtn.vue";
export default {
  mixins: [teableCenterEllipsis, cancelLoading],
  // components: { InvitationCooperationBtn },
  data() {
    return {
      userStatus: 1,
      // 搜索合作伙伴
  ...
  methods: {
    encryptionRules,
    toCompanyInfo () {
      this.$router.push('/account/companyInfo');
    },
    // 检测按钮
    checkBtn(val) {
      this.userStatus = val;
