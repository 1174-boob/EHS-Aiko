<template>
  <div class="upload-can-remove-box">
    <!-- <a-upload :action="action" list-type="picture-card" :disabled="loading" :headers="headers" :before-upload="beforeUpload" :file-list="fileList" @preview="handlePreview" @change="handleChange">
