<template>
  <div ref="table" :id="id" class="advanced-table">
    <a-spin :spinning="loading">
      ...
      <a-table v-bind="{...$props, columns: visibleColumns, title: undefined, loading: false}" :size="sSize" @expandedRowsChange="onExpandedRowsChange" @change="onChange" @expand="onExpand">
